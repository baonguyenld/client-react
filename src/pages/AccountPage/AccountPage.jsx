...
const AccountPage = ({type}) => {
    ...
    const log = async () => {
        ...
        try {
            const response = await fetch("https://server-xi11.onrender.com/api/v1/account/user/login", {
                method: 'POST',
                headers: {
    ...
    } else if(type==1)
    {
        ...
        return(
            <div className='form-log col-6 col-6 d-flex flex-column justify-content-center align-items-center'>
                ...
                Nếu thông tin hợp lệ, mật khẩu mới của bạn sẽ được gởi đến địa chỉ email này.</div>
            </div>
       )
    }
